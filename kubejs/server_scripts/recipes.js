...
ServerEvents.recipes(event => {
  ...
  event.recipes.createPressing('thermal:lumium_plate', 'thermal:lumium_ingot');
	...
	event.recipes.mekanismPurifying('kubejs:fission_pellet', '#forge:dusts/fluorite', {gas: 'mekanism:fissile_fuel', amount: 1});
  ...
  //
	...
	// 	output:{
	// 		infuse_type:"mekanism:darkness_essence",
	// 		amount:10}
	// });
	//
	// event.custom({
	...
	//
  //
	// event.recipes.mekanismMetallurgicInfusing('kubejs:enriched_black_essence', 'kubejs:black_essence', {tag: 'mekanism:refined_obsidian', amount: 40});
	// event.recipes.mekanismMetallurgicInfusing('extendedcrafting:black_iron_ingot', 'minecraft:iron_ingot', {infuse_type: 'mekanism:darkness_essence', amount: 10});
	//
	// event.recipes.mekanismPurifying('kubejs:basilic_reagent', 'thermal:earth_charge', {gas: 'mekanism:sulfuric_acid', amount: 1});
	// event.recipes.mekanismMetallurgicInfusing('kubejs:enriched_basilic_reagent', 'kubejs:basilic_reagent', {infuse_type: 'mekanism:darkness_essence', amount: 40});
	//
	// event.recipes.mekanismMetallurgicInfusing('minecraft:wither_skeleton_skull', 'minecraft:skeleton_skull', {infuse_type: 'mekanism:darkness_essence', amount: 40});
