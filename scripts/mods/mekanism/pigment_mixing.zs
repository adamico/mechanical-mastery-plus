...
<recipetype:mekanism:pigment_mixing>.addRecipe("pigment_mixing/mechanical_blue_red_to_magenta", <pigment:crafttweaker:mechanical_blue>, <pigment:crafttweaker:mechanical_red>, <pigment:crafttweaker:mechanical_magenta> * 2);