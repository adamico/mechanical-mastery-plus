...
<recipetype:mekanism:pigment_extracting>.addRecipe("extract_blue_lumen_paint_ball_pigment", <item:ae2:blue_lumen_paint_ball>, <pigment:crafttweaker:mechanical_blue> * 256);
<recipetype:mekanism:pigment_extracting>.addRecipe("extract_red_lumen_paint_ball_pigment", <item:ae2:red_lumen_paint_ball>, <pigment:crafttweaker:mechanical_red> * 256);