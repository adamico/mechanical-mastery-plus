...
// <recipetype:mekanism:compressing>.addRecipe(name as string, itemInput as ItemStackIngredient, chemicalInput as GasStackIngredient, output as IItemStack)
...
<recipetype:mekanism:compressing>.addRecipe("compress_cube3", <item:kubejs:cube3>, GasStackIngredient.from(<gas:mekanism:osmium> * 9), <item:kubejs:cube3_packaged>);