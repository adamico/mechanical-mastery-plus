...
// <recipetype:mekanism:painting>.addRecipe(name as string, itemInput as ItemStackIngredient, chemicalInput as PigmentStackIngredient, output as IItemStack)
...
<recipetype:mekanism:painting>.addRecipe("paint_cube4", <item:kubejs:cube4_inert>, <pigment:crafttweaker:mechanical_magenta> * 2048, <item:kubejs:cube4>);